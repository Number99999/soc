 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://MyWebService/", wsdlLocation = "http://127.0.0.1:8080/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://MyWebService/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8080/NewWebService?wsdl");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://MyWebService/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://MyWebService/", "NewWebServicePort"), NewWebService.class, features);
    }
